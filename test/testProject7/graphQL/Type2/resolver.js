...
export default {
  ...
  Mutation: {
    async createType2(root, args, context, ast) {
      ...
      await processHook(hooksObj, "Type2", "beforeInsert", newObject, root, args, context, ast);
    ...
    async updateType2(root, args, context, ast) {
      ...
      await processHook(hooksObj, "Type2", "beforeUpdate", $match, updates, root, args, context, ast);
