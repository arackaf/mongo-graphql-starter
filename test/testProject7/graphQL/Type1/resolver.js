...
export default {
  ...
  Mutation: {
    ...
    async updateType1(root, args, context, ast) {
      ...
      await processHook(hooksObj, "Type1", "beforeUpdate", $match, updates, root, args, context, ast);
    ...
    async deleteType1(root, args, context, ast) {
      ...
      await processHook(hooksObj, "Type1", "beforeDelete", $match, root, args, context, ast);
